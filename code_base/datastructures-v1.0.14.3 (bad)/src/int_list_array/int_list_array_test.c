...
/*
 * one_element_list_previous_end_eq_first() - Test that previous on end() in a one-element list returns first().
 * Precondition: list_empty(), list_first(), list_end() works
 */
...
/*
 * one_element_list_prev_is_inv_next() - Test that previous is inverse to next in  a one-element list.
 * Precondition: list_empty(), list_first(), list_end() works
 */
...
/*
 * one_element_list_next_is_inv_prev() - Test that previous is inverse to next in  a one-element list.
 * Precondition: list_empty(), list_first(), list_end() works
 */
